...
export const LLM_MODELS = {
  ...
  ollama_cloud: [
    // Cloud-only models from https://ollama.com/search?c=cloud
    { id: 'glm-5', name: 'GLM-5 (744B, cloud)', cloud: true },
    { id: 'glm-4.7', name: 'GLM 4.7 (cloud)', cloud: true },
    { id: 'glm-4.6', name: 'GLM 4.6 (cloud)', cloud: true },
    { id: 'qwen3.5', name: 'Qwen 3.5 (cloud)', cloud: true },
    { id: 'qwen3-coder-next', name: 'Qwen3 Coder Next (cloud)', cloud: true },
    { id: 'qwen3-vl', name: 'Qwen 3 VL (vision, cloud)', cloud: true },
    { id: 'qwen3-next', name: 'Qwen3 Next (80B, cloud)', cloud: true },
    { id: 'minimax-m2.7', name: 'MiniMax M2.7 (cloud)', cloud: true },
    { id: 'minimax-m2.5', name: 'MiniMax M2.5 (cloud)', cloud: true },
    { id: 'minimax-m2', name: 'MiniMax M2 (cloud)', cloud: true },
    ...
    { id: 'nemotron-3-nano', name: 'Nemotron 3 Nano (cloud)', cloud: true },
    { id: 'ministral-3', name: 'Ministral 3 (cloud)', cloud: true },
    { id: 'rnj-1', name: 'Rnj-1 (8B, tools, cloud)', cloud: true },
    { id: 'gemini-3-flash-preview', name: 'Gemini 3 Flash (cloud)', cloud: true },
    { id: 'cogito-2.1', name: 'Cogito 2.1 (671B, cloud)', cloud: true },
    { id: 'deepseek-v3.2', name: 'DeepSeek V3.2 (cloud)', cloud: true },
  ],
