...
export const LLM_MODELS = {
  ...
  ollama_cloud: [
    { id: 'glm-5', name: 'GLM-5 (744B, cloud)', cloud: true },
    { id: 'glm-4.7-flash', name: 'GLM 4.7 Flash (30B, tools)', cloud: true },
    { id: 'minimax-m2.7', name: 'MiniMax M2.7 (cloud)', cloud: true },
    { id: 'minimax-m2.5', name: 'MiniMax M2.5 (cloud)', cloud: true },
    { id: 'qwen3.5', name: 'Qwen 3.5 (122B MoE, cloud)', cloud: true },
    { id: 'qwen3-coder-next', name: 'Qwen3 Coder Next (cloud)', cloud: true },
    { id: 'qwen3-vl', name: 'Qwen 3 VL (235B, vision, cloud)', cloud: true },
    { id: 'qwen3-next', name: 'Qwen3 Next (80B, tools, cloud)', cloud: true },
    { id: 'nemotron-3-super', name: 'Nemotron 3 Super (120B, cloud)', cloud: true },
    { id: 'devstral-small-2', name: 'Devstral Small 2 (24B, tools, cloud)', cloud: true },
    { id: 'devstral-2', name: 'Devstral 2 (123B, tools, cloud)', cloud: true },
    { id: 'kimi-k2.5', name: 'Kimi K2.5 (cloud)', cloud: true },
    { id: 'ministral-3', name: 'Ministral 3 (cloud)', cloud: true },
    { id: 'lfm2', name: 'LFM2 (24B, tools)', cloud: true },
    { id: 'lfm2.5-thinking', name: 'LFM2.5 Thinking (1.2B, tools)', cloud: true },
    { id: 'rnj-1', name: 'Rnj-1 (8B, cloud)', cloud: true },
    { id: 'gemini-3-flash-preview', name: 'Gemini 3 Flash (vision, cloud)', cloud: true },
    { id: 'deepseek-ocr', name: 'DeepSeek OCR (3B, vision)', cloud: true },
    { id: 'glm-ocr', name: 'GLM OCR (vision, tools)', cloud: true },
    { id: 'translategemma-27b', name: 'TranslateGemma 27B (vision)', cloud: true },
  ],
