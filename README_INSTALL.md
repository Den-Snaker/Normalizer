...
Скачайте `download-normalizer.bat` с GitHub и поместите в папку, где хотите установить программу.

**Способы скачивания:**
- Прямая ссылка: https://github.com/Den-Snaker/Normalizer/raw/main/download-normalizer.bat
- Или: зеленая кнопка "Code" → "Download ZIP" на странице репозитория

### Шаг 1: Запустите скачивание

Дважды кликните на `download-normalizer.bat`. Он:
1. Проверит наличие Git
2. Скачает проект с GitHub
3. Создаст папку `Normalizer`
